import { Body, Controller, Get, HttpCode, HttpStatus, Inject, Logger, Param, Post, Res, ValidationPipe } from '@nestjs/common';
...
export class UsersController {
    ...
    async checkNickname(
        ...
        try{
            const nickName = await this.usersService.findByNickname(nickname);
            if(nickName) 
                return res
                    .status(HttpStatus.CONFLICT)
                    .json({
